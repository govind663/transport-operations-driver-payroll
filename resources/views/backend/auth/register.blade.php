...
<head>
    ...
    {{-- SEO --}}
    <meta name="description" content="Create your TradeBO account to access a secure trading management platform with memberships, user management, reports, and powerful admin features.">
    <meta name="keywords" content="TradeBO Registration, TradeBO Sign Up, Trading CRM Registration, Trading Management System, Create TradeBO Account, Admin Registration, Membership Platform">
    ...
    <!-- Title -->
    <title>{{ config('app.name', 'TradeBO') }} | Register</title>
        ...
        <div class="container">
            <div class="row align-items-center">
                <div class="col-md-6 col-lg-7">
                    <img src="{{ asset('backend/assets/vendors/images/mastermind_register.webp') }}" data-no-optimize="1" alt="register-page-img" />
                </div>
