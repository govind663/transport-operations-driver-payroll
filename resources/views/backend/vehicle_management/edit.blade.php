                            ...
                            <select
                                ...
                                @foreach($vehicleCategories as $vehicleCategory)
                                    ...
                                    <option
                                        ...
                                        {{ old(
                                            'vehicle_category_id',
                                            $vehicleManagement->vehicle_category_id
                            ...
                            <select
                                ...
                                @foreach($vehicleTypes as $vehicleType)
                                    ...
                                    <option
                                        ...
                                        {{ old(
                                            'vehicle_type_id',
                                            $vehicleManagement->vehicle_type_id
                                        ) == $vehicleType->id ? 'selected' : '' }}>
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old(
                                    'vehicle_number',
                                    $vehicleManagement->vehicle_number
                                ) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old(
                                    'registration_number',
                                    $vehicleManagement->registration_number
                                ) }}"
                                placeholder="e.g. MH04AB1234">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old(
                                    'chassis_number',
                                    $vehicleManagement->chassis_number
                                ) }}"
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old(
                                    'engine_number',
                                    $vehicleManagement->engine_number
                                ) }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old(
                                    'manufacturer',
                                    $vehicleManagement->manufacturer
                                ) }}"
                    ...
                    <div class="col-md-4">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old(
                                    'manufacturing_year',
                                    $vehicleManagement->manufacturing_year
                                ) }}"
                        ...
                        <div class="form-group">
                            ...
                            <select
                                ...
                                <option
                                    ...
                                    {{ old(
                                        'capacity_unit',
                                        $vehicleManagement->capacity_unit
                                    ) == 'kg' ? 'selected' : '' }}>
                                    KG
                                </option>
