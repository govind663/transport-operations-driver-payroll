...
<div class="pd-ltr-20 xs-pd-20-10">
    ...
    <div class="min-height-200px">
        ...
        <div class="page-header">
            ...
            <div class="row">
                ...
                <div class="col-md-6 col-sm-12">
                    ...
                    <div class="title">
                        <h4>Create New Vehicle Category</h4>
                    </div>
        ...
        {{-- ================= FORM ================= --}}
        <form
            action="{{ route('vehicle-categories.store') }}"
            method="POST">
                    ...
                    <div class="col-md-6">
                        ...
                        <div class="form-group">
                            ...
                            <input
                                ...
                                value="{{ old('code') }}"
                                placeholder="Enter Category Code (e.g. TRUCK)">
                    ...
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <textarea
                                ...
                                placeholder="Enter vehicle category description">{{ old('description') }}</textarea>
